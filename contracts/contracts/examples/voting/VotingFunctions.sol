...
contract VotingFunctions {
    ...
    function isInOutcomeArea(uint256 outcomeVotes, uint256 againstOutcomeVotes, VoteParametersLib.VoteParameters memory params) public pure returns(bool outcomeChanged) {
        return params.importance * againstOutcomeVotes <= outcomeVotes;
        // return (
    ...
    function isInNonOutcomeArea(uint256 outcomeVotes, uint256 againstOutcomeVotes, VoteParametersLib.VoteParameters memory params) public pure returns(bool outcomeChanged) {
        return outcomeVotes < params.importance * againstOutcomeVotes;
    }
        ...
        returns(bool triggerAction, uint8 actionType)
    {
        ...
        bool isOldInNoArea = isInNonOutcomeArea(oldScoreYes, oldScoreNo, vote.parameters);
        ...
        bool isOldInYesArea = isInNonOutcomeArea(oldScoreNo, oldScoreYes, vote.parameters);
