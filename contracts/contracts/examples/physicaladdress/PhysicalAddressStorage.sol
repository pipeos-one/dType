...
import './PhysicalAddressLib.sol';

contract PhysicalAddressStorage is StorageBase {
    using PhysicalAddressLib for PhysicalAddressLib.PhysicalAddress;

    mapping(bytes32 => Type) public typeStruct;

    struct Type {
        PhysicalAddressLib.PhysicalAddress data;
        uint256 index;
    }
    ...
    function insert(PhysicalAddressLib.PhysicalAddress memory data) public returns (bytes32 hash) {
        // for data integrity
    ...
    function update(bytes32 hashi, PhysicalAddressLib.PhysicalAddress memory data)
        public
    ...
    function getByHash(bytes32 hash) public view returns(PhysicalAddressLib.PhysicalAddress memory data) {
