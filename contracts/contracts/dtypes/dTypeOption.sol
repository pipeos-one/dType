...
contract TypeOptionContract {
    ...
    struct Type {
        dTypeOptionLib.TypeOption data;
        uint256 index;
    }
    ...
    function insert(dTypeOptionLib.TypeOption memory data) public returns (bytes32 hasho) {
    ...
    function insertBytes(bytes memory data) public returns (bytes32 hasho) {
        return insert(dTypeOptionLib.structureBytes(data));
    }
    ...
    function update(bytes32 hashi, dTypeOptionLib.TypeOption memory data)
        public
    ...
    function getByHash(bytes32 hash) public view returns(dTypeOptionLib.TypeOption memory data) {
