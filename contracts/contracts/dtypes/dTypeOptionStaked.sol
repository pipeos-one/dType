...
contract TypeOptionStakedContract {
    ...
    struct Type {
        dTypeOptionStakedLib.TypeOptionStaked data;
        uint256 index;
    }
    ...
    function insert(dTypeOptionStakedLib.TypeOptionStaked memory data) public returns (bytes32 hasho) {
    ...
    function insertBytes(bytes memory data) public returns (bytes32 hasho) {
        return insert(dTypeOptionStakedLib.structureBytes(data));
    }
    ...
    function update(bytes32 hashi, dTypeOptionStakedLib.TypeOptionStaked memory data)
        public
    ...
    function getByHash(bytes32 hash) public view returns(dTypeOptionStakedLib.TypeOptionStaked memory data) {
