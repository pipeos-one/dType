...
contract TypeProposalContract {
    ...
    struct Type {
        dTypeProposalLib.TypeProposal data;
        uint256 index;
    }
    ...
    function insert(dTypeProposalLib.TypeProposal memory data) public returns (bytes32 hasho) {
    ...
    function insertBytes(bytes memory data) public returns (bytes32 hasho) {
        return insert(dTypeProposalLib.structureBytes(data));
    }
    ...
    function update(bytes32 hashi, dTypeProposalLib.TypeProposal memory data)
        public
    ...
    function getByHash(bytes32 hash) public view returns(dTypeProposalLib.TypeProposal memory data) {
